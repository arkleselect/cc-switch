...
export function ProviderCard({
  ...
  return (
    <div
      className={cn(
        "relative flex h-full flex-col overflow-hidden rounded-xl border border-border p-4 transition-all duration-300",
        "bg-card text-card-foreground group",
        isAutoFailoverEnabled || isProxyTakeover
          ? "hover:border-emerald-500/50"
          : "hover:border-[#8a8a8a] active:border-[#9a9a9a]",
        shouldUseGreen &&
          "border-emerald-500/60 shadow-sm shadow-emerald-500/10",
        shouldUseBlue &&
          "border-[#7e7e7e] shadow-[0_0_0_1px_rgba(126,126,126,0.04)] shadow-black/20 hover:border-[#8a8a8a] active:border-[#9a9a9a]",
    ...
    >
      <div
        className={cn(
          ...
          shouldUseBlue && "from-slate-300/6",
            ...
            {displayUrl && (
              <div className="max-w-full">
                <button
                  ...
                  className={cn(
                    "inline-flex max-w-full items-center text-left text-sm",
                    isClickableUrl
          ...
          <div className="flex min-w-0 items-center justify-between gap-3">
            ...
            {hasMultiplePlans && (
              <button
                ...
                className="flex-shrink-0 rounded p-1 text-gray-500 transition-colors hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800"
                title={
                  isExpanded
